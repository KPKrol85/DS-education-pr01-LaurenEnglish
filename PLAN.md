...
- [ ] **PH1-01 — Remove retired interaction branches**
  - [ ] remove the `contactForm.js` import and initializer from `js/main.js` while preserving the native required-field and Netlify Forms contract in `kontakt.html`
